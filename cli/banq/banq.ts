...
const COMMANDS = new Map<string, [Command, LazyCommandFn]>([
  ...
  ["tp",               ["track-position",    () => import("../../cmd/banq/track-position.ts")]],
  ["track-position",   ["track-position",    () => import("../../cmd/banq/track-position.ts")]],
  ["cl",               ["cap-limit",         () => import("../../cmd/banq/cap-limit.ts")]],
  ["cap",              ["cap-limit",         () => import("../../cmd/banq/cap-limit.ts")]],
  ["cap-limit",        ["cap-limit",         () => import("../../cmd/banq/cap-limit.ts")]],
]);
