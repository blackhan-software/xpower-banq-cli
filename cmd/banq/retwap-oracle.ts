...
import { opt_percent_min } from "../../arg/opt-percent.ts";
import { opt_percent_max } from "../../arg/opt-percent.ts";
...
async function rhs_of(FEED: ethers.Contract, { amount }: { amount: number }) {
